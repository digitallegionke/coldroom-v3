    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-background">
      <div className="w-full max-w-lg space-y-8">
        ...
        <div className="bg-card rounded-lg shadow-lg p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-xl font-semibold">Monitor Cold Rooms</h2>
            <p className="text-muted-foreground">
              View real-time temperature, humidity, and capacity data for all your cold rooms. 
              Status indicators show normal (green), warning (yellow), or critical (red) conditions.
            </p>
          </div>
